      ...
      <main className="pt-[72px]">
        ...
        <section className="max-w-[1400px] mx-auto px-6 py-16 md:py-24 grid md:grid-cols-12 gap-12 md:gap-24">
          ...
          <div className="md:col-span-7">
            ...
            <p className="text-xs text-muted-foreground mb-6">Style {product.id.split('-')[0].toUpperCase()} CHIRAGH</p>
                ...
                },
                {
                  ...
                  body: (
                    <p className="text-sm text-[#333] font-light leading-relaxed">
                      Chiragh products are crafted from carefully selected materials. Please handle with care for a longer product life. Protect from direct light, heat, and rain. Store in the provided flannel bag or box.
                    </p>
                  ),
                },
                {
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {product.sizes.map((sz) => (
                      <button
                        ...
                        className={`py-3 text-xs text-center border transition-all ${
                          selectedSize === sz
